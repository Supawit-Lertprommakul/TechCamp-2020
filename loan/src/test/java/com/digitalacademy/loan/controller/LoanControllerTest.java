...
public class LoanControllerTest {
    ...
    @DisplayName("Test get loan info bycustomer id 1 shoud return loan infomation")
    @Test
    void testGetLoanInfoByCustomerIdEquals1() throws Exception {
        ...
        assertEquals(3400000, data.get("principal_amount"));

        verify(loanService, times(1)).getLoanInfoById(reqParam);
    }

    @DisplayName("Test get loan info by customer id 1 shoud return Get loan info not found")
    @Test
    ...
    @DisplayName("Test get loan info by customer id 3 shoud return throw exception")
    @Test
    void testGetLoanInfoByCustomerIdEquals3() throws Exception {
        ...
        assertEquals("Cannot get loan infomation", resp.get("data").toString());
    }
}
